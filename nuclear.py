...
bot = telebot.TeleBot('7690636167:AAFFXaIMoevaoYXdktQS-H2PE5nYbHi2zPY')
...
def authorize_user(message, func):
    ...
    if is_key_valid(message.text):
        ...
        bot.reply_to(message, "❌YOU HAVE NO KEY DM TO BUY @DELTA_013🚀")    
...
➡️ Join Telegram :- https://t.me/+PQ5JbHy9pphhMjM9'''
...
def welcome_rules(message):
    user_name = message.from_user.first_name
    response = f'''{user_name} ♻️PLEASE FOLLOW THESE RULES ♻️:
